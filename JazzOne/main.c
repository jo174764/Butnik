...

{
    ...
    while (1)
    {
        ...
        case TURNL:
                            left_done = (get_left_motor_count() - left_encoder_zero_pos) < -TURN_TARGET_TICKSR;
                            right_done = (get_right_motor_count() - right_encoder_zero_pos) > TURN_TARGET_TICKSR;
        ...
        case TURNLEFT:
            left_done = (left_encoder_zero_pos - get_left_motor_count()) > TURN_TARGET_TICKS90;
            right_done = (right_encoder_zero_pos - get_right_motor_count()) < -TURN_TARGET_TICKS90;
